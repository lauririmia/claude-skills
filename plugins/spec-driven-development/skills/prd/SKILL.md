...
- **Status updates are one line each** ("PRD written to `docs/<feature-id>-<idea-slug>-<file-id>-PRD.md`", "3 issue files written") — no recap of prior steps.
...
- `docs/<feature-id>-<idea-slug>-<file-id>-PRD.md` — structured PRD
- `docs/<feature-id>-<idea-slug>-<file-id>-ISSUE-1.md` … `docs/<feature-id>-<idea-slug>-<file-id>-ISSUE-N.md` — one file per vertical slice, each with its own sequentially assigned `<file-id>`
